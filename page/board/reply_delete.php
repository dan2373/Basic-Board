<?php
    ...
    $rno = $_POST['rno'];
    $sql = query("select * from reply where idx='".$rno."'"); //reply테이블에서 idx가 rno 변수에 저장된 값을 찾음
    ...
    if(password_verify($pwk, $bpw))
        {
            ...
            <script type="text/javascript">alert('댓글이 삭제되었습니다.'); location.replace("/BBS/page/board/read.php?idx=<?php echo $board["idx"]; ?>");</script>
            <?php
            }else{ ?>
