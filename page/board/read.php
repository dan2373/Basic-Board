...
<body>
    ...
    <!-- 목록, 수정, 삭제 -->
        <div id="bo_ser">
            <ul>
                <li><a href="/BBS/index.php">[목록으로]</a></li>
   ...
   <div class="reply_view">
    ...
    <div class="dap_lo">
        ...
        <!-- 댓글 수정 폼 dialog -->
        <div class="dat_edit">
            <form action="/BBS/page/board/rep_modify_ok.php">
                <input type="hidden" name="rno" value="<?php echo $reply['idx']; ?>"/><input type="hidden" name="b_no" value="<?php echo $bno; ?>">
                <input type="password" name="pw" class="dap_sm" placeholder="비밀번호" />
                <textarea name="content" id="dap_edit_t"><?php echo $reply['content']; ?></textarea>
                <input type="submit" value="수정하기" class="re_mo_bt">
            </form>
        </div>
        <!-- 댓글 삭제 비밀번호 확인 -->
        <div class="dat_delete">
            <form action="/BBS/page/board/reply_delete.php" method="post">
                <input type="hidden" name="rno" value="<?php echo $reply['idx']; ?>"/><input type="hidden" name="b_no" value="<?php echo $bno; ?>">
    ...
    <!-- 댓글 입력 폼 -->
    <div class="dap_ins">
        <form action="/BBS/page/board/reply_ok.php?idx=<?php echo $bno; ?>" method="post">
